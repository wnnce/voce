...
from voce.schema import PAYLOAD_LLM_CHUNK, SIGNAL_INTERRUPTER, Payload
...
@plugin(
    ...
    config_type=OpenAIStreamConfig,
    inputs=[
        Property(
            "payload",
            fields=[
...
# IMPORTANT NOTE: The metadata inputs/outputs logic from register() needs to be preserved!
